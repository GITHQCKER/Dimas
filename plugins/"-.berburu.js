...
let randomaku1 = `${Math.floor(Math.random() * 110)}`
let randomaku2 = `${Math.floor(Math.random() * 120)}`
let randomaku4 = `${Math.floor(Math.random() * 130)}`
let randomaku3 = `${Math.floor(Math.random() * 140)}`
let randomaku5 = `${Math.floor(Math.random() * 150)}`
let randomaku6 = `${Math.floor(Math.random() * 160)}`
let randomaku7 = `${Math.floor(Math.random() * 170)}`
let randomaku8 = `${Math.floor(Math.random() * 180)}`
let randomaku9 = `${Math.floor(Math.random() * 190)}`
let randomaku10 = `${Math.floor(Math.random() * 210)}`
let randomaku11 = `${Math.floor(Math.random() * 220)}`
let randomaku12 = `${Math.floor(Math.random() * 210)}`
.trim()
